...
public:
    ...
    void  search(string search, int currentUser) {
        ...
        while (true) {
            ...
            if (cin.fail()) {
                ...
                cout << "Invalid input. Please enter a valid integer or -1 to go back:\n";
            }
            else {
                if (y > 0 and y <= searchResults.size()) {
                    break;
                }
                else {
                    cout << "Invalid input. Please enter a valid integer or -1 to go back:\n";
    ...
    void  peopleYouMayKnow(int currentUser) {
        ...
        {
            cerr << "No friends to find mutuals!" << endl;
            return;
        }
    ...
    void  showRequests(int currentUser) {
        ...
        while (users.get(currentUser)->getRequests().numberOfElements != 0)
        {
            cout << "Enter index of user u want to view or -1 to go back\n";
            cin >> userIndex;
            if (cin.fail()) {
                ...
                if (userIndex == -1)
                    break;
                if (0 < userIndex and userIndex <= requestingUsers.size()) {
